...
let arrayModificato = [];
for (let i = 0; i < starWarsCharacters.length; i++) {
  let charactersCopy = {...starWarsCharacters[i]} //...(Spread Operator) Copia dell'oggetto, senza modificarlo.
  if (charactersCopy.gender = 'n/a') {
    charactersCopy.gender = 'robot'
  }
  arrayModificato.push(charactersCopy)
}
